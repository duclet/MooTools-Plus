...
var StoredInstances = new Class({
	...
	/**
	 * Store this instance. Note that this will NOT overwrite another instance
	 * if the provided id already exists.
	 *
	 * @param String	id	The identifier for this instance.
	 * @returns Mixed	Returns true if the instance was successfully stored. If
	 * 		the another instance was already stored with the provided id, that
