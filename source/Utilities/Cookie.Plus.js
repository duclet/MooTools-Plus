...
Class.refactor(Cookie, {
	/**
	 * @type {Object.<string, *>}	Adds another option to specify the type of the duration. The
	 * 		supported types are: years, days, hours, minutes, and seconds. Defaults to days.
	 */
	options: { type: 'days' },
